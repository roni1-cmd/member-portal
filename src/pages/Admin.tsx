          ...
          <SidebarContent className="py-2">
            ...
            <SidebarGroup>
              <SidebarGroupContent>
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className="h-12 px-6 rounded-r-full rounded-l-none text-muted-foreground hover:bg-secondary hover:text-foreground">
                      <Link to="/">
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton
                      ...
                      className={`h-12 px-6 rounded-r-full rounded-l-none cursor-pointer ${
                        activeView === "calendar"
                ...
                <SidebarMenu>
                  {Object.entries(applicationsByPosition).map(([position, apps]) => (
                    <SidebarMenuItem key={position}>
                      <SidebarMenuButton
                        onClick={() => setActiveView("applications")}
                        className="h-14 px-6 rounded-r-full rounded-l-none text-foreground hover:bg-secondary group cursor-pointer"
                      >
