...
import { Check, ChevronRight, ChevronLeft, User, Briefcase, FileText, Send } from "lucide-react";
...
const formSchema = z.object({
  ...
  position: z.enum(positions, { required_error: "Please select a position" }),
  ...
  if (isSubmitted) {
    return (
      <div className="form-card text-center animate-fade-in">
        ...
        <h2 className="font-display text-3xl mb-4 text-foreground">Application Submitted!</h2>
        ...
        {steps.map((step, index) => (
          <div key={step.id} className="flex items-center">
            ...
            {index < steps.length - 1 && (
              <div
                className={cn(
                  "w-12 sm:w-20 lg:w-32 h-0.5 mx-2 transition-colors duration-300",
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="form-card">
        ...
        {currentStep === 1 && (
          <div className="animate-slide-in-right">
            <h2 className="font-display text-2xl md:text-3xl mb-2 text-foreground">Personal Information</h2>
        ...
        {currentStep === 2 && (
          <div className="animate-slide-in-right">
            <h2 className="font-display text-2xl md:text-3xl mb-2 text-foreground">Position Selection</h2>
            <p className="text-muted-foreground mb-8 font-serif">Choose your desired role</p>
        ...
        {currentStep === 3 && (
          <div className="animate-slide-in-right">
            <h2 className="font-display text-2xl md:text-3xl mb-2 text-foreground">Experience & Portfolio</h2>
        ...
        {currentStep === 4 && (
          <div className="animate-slide-in-right">
            <h2 className="font-display text-2xl md:text-3xl mb-2 text-foreground">Final Details</h2>
